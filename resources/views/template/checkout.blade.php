			...
			<table class="timetable_sub">
				<thead>
					...
					<tr class="rem1">
						...
						<td class="invert-image"><a href="product.blade.php"><img src="images/w4.png" alt=" " class="img-responsive" /></a></td>
						<td class="invert">
							 <div class="quantity">
					...
					<tr class="rem2">
						...
						<td class="invert-image"><a href="product.blade.php"><img src="images/ep3.png" alt=" " class="img-responsive" /></a></td>
						<td class="invert">
							 <div class="quantity">
								<div class="quantity-select">
									<div class="entry value-minus">&nbsp;</div>
					...
					<tr class="rem3">
						...
						<td class="invert-image"><a href="product.blade.php"><img src="images/w2.png" alt=" " class="img-responsive" /></a></td>
						<td class="invert">
							 <div class="quantity">
								<div class="quantity-select">
									<div class="entry value-minus">&nbsp;</div>
					...
					<tr class="rem4">
						...
						<td class="invert-image"><a href="product.blade.php"><img src="images/w1.png" alt=" " class="img-responsive" /></a></td>
						<td class="invert">
							 <div class="quantity">
								<div class="quantity-select">
									<div class="entry value-minus">&nbsp;</div>
...
<div class="footer">
	<div class="container">
		<div class="col-md-3 footer-left">
			<h2><a href="index.blade.php"><img src="images/logo3.jpg" alt=" " /></a></h2>
			<p>Neque porro quisquam est, qui dolorem ipsum quia dolor
			...
			<div class="sign-grds">
				<div class="col-md-4 sign-gd">
					...
					<ul>
						...
						<li><a href="category.blade.php">Women's Wear</a></li>
						<li><a href="search.blade.php">Electronics</a></li>
